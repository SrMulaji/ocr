...
<head>
	...
	<title>OCR |Admin Manage testimonials   </title>
...
{				?>	
	...
	<td><?php echo htmlentities($result->dob);?></td>
                                            ...
                                            <td><a href="edit-brand.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                <a href="edit-brand.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
