      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Find the ideal vehicle for your needs.</h1>
            <p>We have more vehicles for you to choose. </p>
        </div>
      </div>
    </div>
  </div>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the Best <span>Vehicle possible</span></h2>
...
<span class="price">R<?php echo htmlentities($result->PricePerDay);?> /Day</span> 
</div>
